	...
	<div class="row justify-content-md-center">
		<div class="col-md-6">
			<div class="card bg-light my-5">
				...
				<div class="card-header text-center">Tambah Jumlah</div>
				...
				<div class="card-body">
					...
					<form action="" method="post" class="needs-validation" novalidate>
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="Masukan jumlah stok barang" autocomplete="off" required >
