                            ...
                            <?php foreach ($results as $row) : ?>
                              <tr>
                               <th scope="" ope="row"><?= $i; ?></th>
                                ...
                                <td><?= $row->stok;?>  <a href="<?= base_url('S_pharmapreneur/pp_stok/'. $row->id);?>" class="badge badge-primary">+</a></td>
                                <td>
                                  <a href="<?= base_url('s_pharmapreneur/pp_pass/'. $row->id);?>" class="badge badge-success">edit</a>
                                  <a href="<?= base_url('s_pharmapreneur/pp_delete/'. $row->id); ?> " class="badge badge-danger">delete</a>
                                </td>
                              </tr>
                              <?php $i++;?>
                            <?php endforeach; ?>
...
<div class="modal fade" id="newTambahBarang" tabindex="-1" aria-labelledby="newTambahBarang" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('s_pharmapreneur'); ?>" method="post">
...
<div class="modal fade" id="modalUpload" tabindex="-1" role="dialog" aria-labelledby="modalUploadLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content p-2">
      ...
      <div class="modal-body">
        <form id="form-upload" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?= base_url('s_pharmapreneur/saveimport');?>">
