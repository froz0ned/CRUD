	...
	<div class="row justify-content-md-center">
		<div class="col-md-6">
			<div class="card bg-light my-5">
				...
				<div class="card-body">
					<a href="<?= base_url('s_luxmanabadi'); ?>" class="badge badge-primary">kembali</a>
					<form action="<?= base_url('s_luxmanabadi/lux_edit/'. $read['id']);?>" method="post" class="needs-validation" novalidate>
