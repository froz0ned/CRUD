...
class Shopee extends CI_Controller 
{
	public function __construct()
	{
		...
		$this->load->model('S_planetkimiam');
		$this->load->library('excel');
	}

	public function planetkimia(){
		$data['title'] = 'Planet Kimia';
		$data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
		$data['bahan'] = $this->db->get('bahanbaku')->result_array();
		
		$query = $this->db->get('s_planetkimia');
		...
		$this->load->view('shopee/planetkimia', $data);
		$this->load->view('templates/footer');
			...
			$this->S_planetkimiam->get_bahan($this->input->post('bahan_id'));
			$this->db->insert('s_planetkimia',$data);
			$this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">
			Tambah Barang Berhasil
			</div>');
			redirect('shopee/planetkimia');
		}
	...
	public function pk_delete($id){
		$data['title'] = 'Planet Kimia';
		$data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
		$data['read'] = $this->db->get_where('s_planetkimia', ['id' => $id])->row_array();
		...
		$this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('shopee/pkdelete', $data);
		$this->load->view('templates/footer');
		} else {
			if ($this->input->post('pass') == "luxmanabadi"){
			$this->db->where('id', $id);
	        $this->db->delete('s_planetkimia');
            $this->session->set_flashdata('message','<div class="alert alert-danger" role="alert">
			Barang Berhasil Dihapus
			</div>');
            redirect('shopee/planetkimia','refresh');
			} 
	...
	public function pk_pass($id){
		...
		$this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('shopee/pkpass', $data);
		$this->load->view('templates/footer');
		} else {
			if ($this->input->post('pass') == "luxmanabadi"){
			$this->pk_edit($id);
	...
	public function pk_edit($id){
		...
		$this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('shopee/pkedit', $data);
		$this->load->view('templates/footer');
		} else {
			$data = [
				'kd_brg' => $this->input->post('kd_brg'),
        	...
        	$this->db->update('s_planetkimia', $data);
			$this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">
		...
		$this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('shopee/pktambah', $data);
		$this->load->view('templates/footer');
		} else {
		$this->S_planetkimiam->get_bahan($this->input->post('bahan_id'));
	...
	public function saveimport()
    {
      if(isset($_FILES["file"]["name"]))
      {
        ...
        $this->S_planetkimiam->insertimport($data);
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">
	      Import Berhasil
	      </div>');
      redirect('shopee/planetkimia');
